...
class view{
	...
	public function view_draw($config, $show){
		...
		if($config['SWITCH']){
			browser\page::addHeader('<script src="' . SiteDomain . '/core/lib/controls/checkbox/ect/bootstrap-switch.min.js"></script>');
			browser\page::addHeader('<link rel="stylesheet" type="text/css" href="' . SiteDomain . '/core/lib/controls/checkbox/ect/bootstrap-switch.min.css" />');
		}
