<div class="form-group">
	<div class="row">
		<div class="col-sm-<?php echo $size;?>">
			<?php if( $switch && $show_label ){ ?><?php echo $label;?><?php } ?>
			<div class="checkbox">
				...
				<label>
					<input
						...
						> <?php if( !$switch ){ ?><?php echo $label;?><?php } ?>
				</label>
			</div>
...
<?php if( $switch ){ ?>
	<script>
		$.fn.bootstrapSwitch.defaults.onText = '<?php echo $ontext;?>';
		$.fn.bootstrapSwitch.defaults.offText = '<?php echo $offtext;?>';
		$.fn.bootstrapSwitch.defaults.size = 'small';
		<?php if( !$show_label ){ ?>$.fn.bootstrapSwitch.defaults.labelText = '<?php echo $label;?>';<?php } ?>
		$("[name='<?php echo $id;?>']").bootstrapSwitch(); 
	</script>
<?php } ?>
